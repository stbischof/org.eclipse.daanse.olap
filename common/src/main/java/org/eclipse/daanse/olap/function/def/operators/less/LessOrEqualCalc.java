...
public class LessOrEqualCalc extends AbstractProfilingNestedBooleanCalc {

    protected LessOrEqualCalc(Type type, final DoubleCalc calc0, final DoubleCalc calc1) {
