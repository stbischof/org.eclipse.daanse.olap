...
public class GreaterOrEqualCalc extends AbstractProfilingNestedBooleanCalc {

    protected GreaterOrEqualCalc(Type type, final DoubleCalc calc0, final DoubleCalc calc1) {
